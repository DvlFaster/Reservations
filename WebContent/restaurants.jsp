...
<body>
	...
	<div class="extra">
		...
		<!--==============================content================================-->
			...
			<div class="main">
				<section id="content">
				<h3>Резервция на ресторант</h3>
				<div class="row">
						<div class="col-sm-5 col-xs-5">
						<label for="restaurant"></label><select id="restaurant" class="form-control"><option
									value="0" selected>Избери Ресторант</option>
									<option>Даяна1</option>
									<option>Джоана</option>
									<option>Южен полъх</option>
									<option>Лайпциг</option></select>
						<label
								for="kitchen"></label> <select id="kitchen" class="form-control"><option
									value="0" selected>Кухня</option>
								<option>BBQ</option>
							...
							<label for="people"></label> <select id="people"
								...
								<option>23:30 часа</option>
									...
									<a class="button-3" href="#">Резервирай </a>
